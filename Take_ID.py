...
parser.add_argument('--image','-i', default='images/nagyung3.jpg', type=str,help='input the image of the person')
parser.add_argument('--name','-n', default='nagyung', type=str,help='input the name of the person')
